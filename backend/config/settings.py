...
# Load the SECRET_KEY from your .env file
SECRET_KEY = os.getenv('SECRET_KEY')

# SECURITY WARNING: don't run with debug turned on in production!
# Set DEBUG to False in production. 'False' in .env will be read as a string.
DEBUG = os.getenv('DEBUG', 'False') == 'True'

# Add your production domain name here when you deploy
ALLOWED_HOSTS = []
...
AUTH_USER_MODEL = 'vault_app.User'

# Re-enable your REST_FRAMEWORK settings
# REST_FRAMEWORK = {
